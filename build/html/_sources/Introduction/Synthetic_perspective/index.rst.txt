...
In the figure, the synthetic vertical-component waveforms (filtered between 1-7 Hz) are shown (a), and they're computed in the one-layer crust model (d) by using the frequency-wavenumber (FK) sythetic seismogram package (`Zhu & Rivera, 2002 <https://onlinelibrary.wiley.com/doi/abs/10.1046/j.1365-246X.2002.01610.x>`_).
